...
d3.csv("https://raw.githubusercontent.com/Mithileysh/sift-ediscovery/master/Datasets/Enron/enron_flatfile_v2.csv", function(error, data) {
  ...
  var ndx    = crossfilter(data),
      hourYearDim = ndx.dimension(function(d) { return [+d.Hour, +d.Year]; }),
      hourYearGroup = hourYearDim.group().reduceSum(function(d) { return +d.email_Value; }),
      hourMonthDim = ndx.dimension(function(d) { return [+d.Hour, +d.Month]; }),
      hourMonthGroup = hourMonthDim.group().reduceSum(function(d) { return +d.email_Value; }),
      hourDayDim = ndx.dimension(function(d) { return [+d.Hour, +d.Day]; }),
      hourDayGroup = hourDayDim.group().reduceSum(function(d) { return +d.email_Value; }),
      hourDaynameDim = ndx.dimension(function(d) { return [+d.Hour, d.DayName]; }),
      hourDaynameGroup = hourDaynameDim.group().reduceSum(function(d) { return +d.email_Value; }),
      yearDimension = ndx.dimension(function(d) { return d.Year; }),
      yearGroup = yearDimension.group().reduceSum(function(d) { return +d.email_Value; }),
      monthDimension = ndx.dimension(function(d) { return d.Month; }),
      monthGroup = monthDimension.group().reduceSum(function(d) { return +d.email_Value; }),
      dayDimension = ndx.dimension(function (d) { return d.Day; }),
...
//Message ID Chart
  ...
  messageIdChart.data(function(messageIdGroup) {
   return messageIdGroup.top(maxItems=10);
});
  ...
  sentChart.data(function(sentGroup) {
   return sentGroup.top(maxItems=10);
});
 ...
 //Individuals Receive Chart 
  ...
  receiveChart.data(function(receiveGroup) {
   return receiveGroup.top(maxItems=10);
});
